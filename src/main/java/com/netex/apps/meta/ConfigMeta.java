...
/**
 * <p>Title: science</p>
 * <p>Description: com.netex.apps.meta.ConfigMeta</p>
...
public class ConfigMeta {
    ...
    public static final String SOURCE_DIRECTORY_IS_REQUIRED = "Source directory is required!";
    public static final String SOURCE_DIRECTORY_IS_NOT_EXISTED = "Source directory is not existed!";
    public static final String THE_MATCHED_SOURCE_FILE_NAME_IS_REQUIRED = "The matched source file name is required!";
    public static final String TARGET_DIRECTORY_IS_NOT_EXISTED = "Target directory is not existed!";
    public static final String TARGET_FILE_FORMAT_IS_REQUIRED = "Target file format is required!";
    public static final String SUCCESSFULLY = "Successfully!";
    public static final String SOURCE_FILE_IS_REQUIRED = "Source file is required!";
    public static final String SOURCE_FILE_IS_NOT_EXISTED = "Source file is not existed!";
    ...
    public static final String ATTEMPT_TO_SHUTDOWN_OUTER_EXECUTOR = "Attempt to shutdown outer executor!";
    public static final String OUTER_TASKS_INTERRUPTED = "Outer tasks interrupted!";
    public static final String CANCEL_NON_FINISHED_OUTER_TASKS = "Cancel non-finished outer tasks!";
    public static final String SHUTDOWN_OUTER_THREAD_FINISHED = "Shutdown outer thread finished!";
    public static final String SOURCE_FILE_NAME_IS_ILLEGAL = "Source file name is illegal.";
    public static final String TARGET_FILE_NAME_IS_ILLEGAL = "Target file name is illegal.";
    public static final String PICTURE_FOLDER_MODERN_PNG = "picture/folder-modern.png";
    public static final String PICTURE_TEXT_X_GENERIC_PNG = "picture/text-x-generic.png";
    public static final String DESKTOP_IS_NOT_SUPPORTED_IN_CURRENT_OS = "Desktop is not supported in current OS!";
