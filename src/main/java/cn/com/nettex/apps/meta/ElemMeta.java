...
public class ElemMeta {
    ...
    public static final String STAGE_IS_NOT_EXIST_PLEASE_DOUBLE_CHECK = "Stage is not exist, please double check!";
    public static final String STAGE_IS_SUCCESSFULLY_REMOVED = "Stage is successfully removed!";
